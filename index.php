<html>
    ...
    <body>
        ...
        <aside>
            ...
            IP: <input type="text" name="board_ip" value="<?php echo $board_ip;?>"><br><br>
            Manufacturer: <input type="text" name="dev_manu" value="<?php echo $dev_manu;?>"><br><br>
            Device: <input type="text" name="dev_name" value="<?php echo $dev_name;?>"><br><br>
            Connection type:<br/>
